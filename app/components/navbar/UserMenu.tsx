    ...
    return(
        <div className="relative">
            <div className="flex flex-row items-center gap-3">
                ...
                <div onClick={toggleOpen} className="p-4 md:py-1 md:px-4 border-[1px] border-neutral-200 flex flex-row items-center gap-3 rounded-full cursor-pointer hover:shadow-md transition">
                    <AiOutlineMenu />
                ...
                <div className="absolute rounded-xl shadow-md w-[40vw] md:w-3/4 bg-white overflow-hidden right-0 top-12 text-sm">
                    <div className="flex flex-col cursor-pointer">
                        {currentUser ? (
                                ...
                                <MenuItem onClick={rentModal.onOpen} label="AirBnB  Mi Hogar"/>
                                <hr />
